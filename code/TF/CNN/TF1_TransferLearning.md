...
　ＩＳＢＮ：	9787111631262
 ...
 https://github.com/nfmcclure/tensorflow_cookbook[第一版]
...
```
Transfer Learning
8.4 再訓練已有的CNN模型 Retraining existing CNN models
資料處理Download/Saving CIFAR-10 images in Inception format
#---------------------------------------
#
...
# 將陣列保存成圖像的多種方法
# https://blog.csdn.net/c20081052/article/details/80917841
